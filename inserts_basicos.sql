...
INSERT INTO tbl_categoria VALUES(NULL, 'Romance'),(NULL,'Terror'),(NULL,'Suspense'),(NULL,'Fantasia'),(NULL,'Mitologia'),(NULL,'Policial'),(NULL,'Aventura'),(NULL,'Ficção Científica'),(NULL,'Drama'),(NULL, 'Literatura Estrangeira');

INSERT INTO tbl_editora VALUES (NULL,'EDITORA INTRÍNSECA'),(NULL,'LEYA'),(NULL,'ROCCO JOVENS LEITORES '),(NULL,'Galera Record'),(NULL,'Martin Claret');

INSERT INTO tbl_autor VALUES (NULL,'Stephenie Meyer'),(NULL,'George R. R. Martin'),(NULL,'Suzanne Collins'),(NULL,'Cassandra Clare'),(NULL,'Machado de Assis'),(NULL,'Rick Riordan');

INSERT INTO tbl_livro VALUES 
(NULL,'A Hospedeira','content/imagens/livros_gerais/a_hospedeira.jpg',1,'978-85-9807-859-5','Melanie Stryder se recusa a desaparecer. Nosso planeta foi dominado
...
(NULL,'A Tormenta de Espadas','content/imagens/livros_gerais/got1.jpg',1,'978-85-8044-262-5','A tormenta de espadas, o terceiro livro da série de George R. R.
