<?php
	...
	if($_SESSION['nivel_acesso'] == 1)
	{
		...
		$pesquisar_novas = new Pesquisar('tbl_notificacoes','*','tipo = 3 AND visualizado = "false" AND usuario_id = '.$_SESSION['id']);
		$resultado_novas = $pesquisar_novas->pesquisar();
		
		$pesquisar_antigas = new Pesquisar('tbl_notificacoes','*','tipo = 3 AND visualizado = "true" AND usuario_id = '.$_SESSION['id']);
