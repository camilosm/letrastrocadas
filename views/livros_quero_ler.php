<?php
	...
	{ 
		...
		$tabelas = "tbl_marcacao marcacao INNER JOIN tbl_livro livro INNER JOIN tbl_editora editora INNER JOIN tbl_autor autor ON id_marcacao = 1 AND id_editora = editora_id AND id_autor = autor_id AND id_livro = livro_id";
